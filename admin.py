...
# ADMIN_IDS loaded from env in main, but for decorator we need access.
# Ideally we should move ADMIN_IDS to config.py or similar, but for now let's load here too or pass it.
# Better: Check against os.getenv directly in decorator to avoid circular imports or global state issues.
import os
